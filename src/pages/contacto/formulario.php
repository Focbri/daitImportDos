...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $destinatario = "ventas@daitimport.com"; // Reemplaza esto con la dirección de correo a la que deseas enviar el mensaje.
    ...
    if ($enviado) {
      ...
      <body>
        ...
        <br>
        <a href="/"> volver a daitimport.com</a>
      </body>
      </html>
      <?php
    } else {
